		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-md-10 col-lg-8">
					...
					<h2 class="display-5 mb-4 mb-md-5 mb-xl-8">We're always on the
						lookout to work with new clients. Please get in touch in one of
						the following ways.</h2>
				</div>
			</div>
		</div>
				...
				<div class="col-12 col-lg-6">
					<div class="border overflow-hidden">
							...
							<div class="row gy-4 gy-xl-5 p-4 p-xl-5">
								<div class="col-12">
									<label for="fullname" class="form-label">Full Name <span
										...
										class="form-control" id="fullname" name="fullname" value=""
										required>
								</div>
                      ...
                      <path
										...
										</span> <input type="tel" class="form-control" id="phone"
											name="phone" value="">
									</div>
								</div>
								<div class="col-12">
				...
				<div class="col-12 col-lg-6">
                  ...
                  <path fill-rule="evenodd"
								...
								<div>
									...
									<address class="m-0 text-secondary">754200, Cuttack,
										Patapur</address>
								</div>
							</div>
                      ...
                      <path
										...
										<div>
											...
											<p class="mb-0">
												<a class="link-secondary text-decoration-none"
													href="tel:+918908876542">8908876542</a>
											</p>
										</div>
									</div>
								</div>
								<div class="col-12 col-sm-6">
									<div class="mb-4 mb-sm-0">
										<div class="mb-3 text-primary">
											<svg xmlns="http://www.w3.org/2000/svg" width="32"
												height="32" fill="currentColor" class="bi bi-envelope-at"
												viewBox="0 0 16 16">
                      <path
                      ...
                      <path
										...
										<div>
											...
											<p class="mb-0">
												<a class="link-secondary text-decoration-none"
													href="mailto:suryaduttadash@gmail.com">employeemn@email.com</a>
											</p>
										</div>
									</div>
								</div>
